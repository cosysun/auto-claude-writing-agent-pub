...
这意味着什么？意味着过去2小时的上下文全没了。我得重新跟它讲一遍：项目背景是什么、技术栈选了哪些、为什么这么选、刚才讨论的架构方案是什么...
...
一个中等复杂度的项目讨论，轻松上万字。如果你在写长文、做项目、整理资料，上下文很快就满了。
...
恒定时间查找。不管卡片柜里有100张卡片还是100万张，查找速度一样快。
...
传统上下文窗口像**临时工作台**，能放的东西有限，放多了就乱。

Engram像**档案室**，东西再多也能快速找到。
...
如果放个完整代码，开发者拿去跑不通，还得骂"开源骗人"。演示代码清楚标明"这是demo"，反而让人明白怎么用。
...
Engram提供了一个新思路：**用"索引卡片柜"（静态记忆）代替无限扩展"临时便签"（上下文窗口）。**
